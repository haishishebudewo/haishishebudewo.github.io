...
$("#btn_right").on("click", function () {
    ...
    //切换图片
    $(".huan_xi_bu_scenery_hd>ul").css("left", $(this).attr("index") * -width);
    //更改当前图片值
...
$("#btn_left").on("click", function () {
    if (parseInt($(".huanxi_bu_bd_anliu_boder").attr("index")) === 1 && $(".huanxi_bu_bd_anliu_ul>ul>li").length > 5) {
        //移动ul的位置，显示最后5张
        $(".huanxi_bu_bd_anliu_ul>ul").css("left", ($(".huanxi_bu_bd_anliu_ul>ul>li").length - 5) * -85 + "px");
        $(".huanxi_bu_bd_anliu_ul>ul>li").removeClass("huanxi_bu_bd_anliu_boder");
    ...
    //更改当前图片值
    $(".huan_xi_bu_scenery_bd").find("span").text($(".huanxi_bu_bd_anliu_boder").attr("index"));
    if (parseInt($(".huanxi_bu_bd_anliu_boder").attr("index")) <= 8) {
        //更改当前ul左移动的距离
        let distace = 8 - $(".huanxi_bu_bd_anliu_boder").attr("index");
        $(".huanxi_bu_bd_anliu_ul>ul").css("left", (85 * distace) + (($(".huanxi_bu_bd_anliu_ul>ul>li").length - 5) * -85) + "px");
    }
});
//进入大图显示按钮
...
$("#huan_xi_bu_da_img1").on("click", function () {
    ...
    if (parseInt($(".huanxi_bu_bd_anliu_boder").attr("index")) === 1) {
        //移动ul的位置，显示最后5张
        $(".huanxi_bu_bd_anliu_ul>ul").css("left", ($(".huanxi_bu_bd_anliu_ul>ul>li").length - 5) * -85 + "px");
        $(".huanxi_bu_bd_anliu_ul>ul>li").removeClass("huanxi_bu_bd_anliu_boder");
        $(".huanxi_bu_bd_anliu_ul>ul>li:last").addClass("huanxi_bu_bd_anliu_boder");
